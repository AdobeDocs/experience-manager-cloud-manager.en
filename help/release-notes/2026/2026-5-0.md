...
A new build model compiles only changed modules (rather than the entire repository) using module-level caching, which reduces build times. It applies to Code Quality and Full Stack pipelines.
