...
A new build model compiles only changed modules (rather than the entire repo) using module-level caching, shortening build times. It applies to Code Quality and Full Stack pipelines.
