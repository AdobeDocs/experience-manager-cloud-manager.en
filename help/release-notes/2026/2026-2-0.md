...
description: Learn about the release of Cloud Manager 2026.2.0 on Adobe Managed Services.
feature: Release Information
exl-id: 65dacedb-3ded-48cf-96e9-fdbe905c3e20
---
# Release notes for Cloud Manager 2026.2.0 on Adobe Managed Services {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Learn about the release of [!UICONTROL Cloud Manager] 2026.2.0 on Adobe Managed Services.
...
The release date for [!UICONTROL Cloud Manager] 2026.2.0 is Thursday, February 5, 2026. 
...
* **Stability, performance, and reliability improvements**
    ...
    This release includes optimization and maintenance updates that improve the stability, performance, and reliability of Cloud Manager.


## Beta programs {#beta-program}

To receive early access to upcoming features before their general release, participate in [!UICONTROL Cloud Manager]'s beta programs.

The following opportunities are currently available:

### Experience Hub Extensibility and Customization {#exp-hub-extensibility}

[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub) is the central access point for AEM, customized for your organization's needs. Provide Adobe with details about your existing AEM UI extensions so they can help you enable them in Experience Hub.
...
To participate, email [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com) with your Adobe OrgID and a short description of the customization you intend to create.

### Faster builds with module caching {#quick-build-cm-pipelines}

A new build model compiles only changed modules (rather than the entire repository) using module-level caching to reduce build times. It applies to code-quality, full-stack, and stage-only pipelines.
...
To participate, email [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com) with your Adobe OrgID and Program ID.

<!-- You can deactivate incremental builds at the pipeline level by setting the property `CM_BUILD_DISABLE_MODULE_CACHING` to `true` (effective during the `BUILD` step). For how to add pipeline variables, see [Pipeline variables](/help/getting-started/build-environment.md#pipeline-variables). -->

## Bug fixes {#bug-fixes}

There are no significant bug fixes in the February 2026 Cloud Manager on AMS release. 
