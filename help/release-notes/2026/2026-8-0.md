...
description: Learn about the release of Cloud Manager 2026.8.0 in Adobe Managed Services.
...
# Release notes for Cloud Manager 2026.8.0 in Adobe Managed Services {#release-notes}

<!-- add "hold: true" to metadata above to be able to commit/merge to Main WITHOUT Publishig -->

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Learn about the release of [!UICONTROL Cloud Manager] 2026.8.0 in Adobe Managed Services.
...
The release date for [!UICONTROL Cloud Manager] 2026.8.0 is Thursday, August 6, 2026. 
...
There are no significant new features in the August 2026 Cloud Manager on AMS release.
