...
* **Support for UI extensibility in AEM Experience Hub**
    Support for UI Extensions in [AEM Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub) is now enabled. This lets developers extend the interface with custom functionality and widgets built using Adobe App Builder. 
