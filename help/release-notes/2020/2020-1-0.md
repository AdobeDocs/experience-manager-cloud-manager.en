...
* Git credentials can now be obtained from inside the Cloud Manager user interface. Refer to [Accessing Git](/help/managing-code/repositories.md) for more details.
