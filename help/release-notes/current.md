...
* **Staging-only and production-only pipelines**
    ...
    Cloud Manager now supports staging-only and production-only pipelines. This feature lets you split full-stack production deployments into smaller, purpose-specific pipelines. <!-- This feature went into GA from Beta in the June 5, 2025 CM release -->
