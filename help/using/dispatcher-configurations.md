...
To take advantage of this capability, the Maven build should produce a zip file which contains at least two directories - ***conf*** and ***conf.d***. This zip file can be produced using the maven-assembly-plugin. Projects generated by Cloud Manager using the built-in [wizard](/help/using/using-the-wizard.md) have the correct Maven project structure created as part of the project creation. This is the recommended path for new Managed Services customers.
