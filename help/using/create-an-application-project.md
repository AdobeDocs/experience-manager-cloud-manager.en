...
It is a good practice to deploy the Java sources alongside with the binary to a Maven repository. Configure the maven-source-plugin in your project:
...
It is a good practice to deploy the whole project source alongside with the binary to a Maven repository - this allows as to rebuild the exact artifact. Configure the maven-assembly-plugin in your project:
