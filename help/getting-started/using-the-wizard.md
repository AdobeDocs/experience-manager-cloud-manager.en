...
When you are onboarded to Cloud Manager as a new customer, you are provided with an empty Git repository. To help you get started, Cloud Manager offers a wizard to create a minimal AEM project based on the [AEM Project Archetype](https://github.com/adobe/aem-project-archetype) as a starting point.
...
1. If you have not already, [create your program](program-setup.md). When the program is created, Cloud Manager detects that the repository is not set up. A special prompt card then appears on the **Overview** screen.
...
You now have a base project. You can now configure your pipelines.

## Existing or migrating customers {#existing-migrating}

If you are a current Adobe Managed Services (AMS) customer or an on-premises AEM customer who is migrating, you have project code already in Git or another version control system.
