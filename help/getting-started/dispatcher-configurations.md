...
Projects generated by Cloud Manager using the built-in [project creation wizard](/help/using/using-the-wizard.md) have the correct Maven project structure created automatically. This is the recommended path if you are new to Adobe Managed Services (AMS).
