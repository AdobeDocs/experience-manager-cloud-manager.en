...
As an AEM (Adobe Experience Manager) user, you fit one of the following scenarios:

* You are new to AEM. 
* You are currently using AEM 6.x.
* You need to upgrade to AEM 6.5 to use [!UICONTROL Cloud Manager].

This document describes these three scenarios and explains the process to get started with [!UICONTROL Cloud Manager].
...
As a new customer, you are onboarded to [!UICONTROL Cloud Manager] as part of the onboarding process to Adobe Managed Services.
...
Your existing AEM project also needs to conform to the recommended practices, because you begin using [!UICONTROL Cloud Manager] to deploy new code changes to your AEM environments.
...
Log into the [!UICONTROL Experience Cloud] landing page using your Adobe Identity Management credentials. Select AEM from the solution switcher to access [!UICONTROL Cloud Manager] and your AEM environments.

After logging in to [!UICONTROL Cloud Manager] for the first time, you have access to your AEM environments directly from the [!UICONTROL Cloud Manager] UI. At this point, you are ready to use all the features of [!UICONTROL Cloud Manager] and prepare your first code branch to be deployed to your stage and production environments.
...
1. Define your load and performance KPIs (Key Performance Indicators).
...
## Process overview {#end-to-end-journey}

The following diagram summarizes the process when using the [!UICONTROL Cloud Manager] CI/CD pipeline for deploying your code changes to your staging and production environments.

![Customer journey for onboarding to Cloud Manager, showing the path for new and existing customers through environment provisioning or upgrades, user and role management, project implementation, and the CI/CD pipeline.](/help/assets/screen_shot_2018-05-15at124004pm.png)
