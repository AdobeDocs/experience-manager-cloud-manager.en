...
If you use [private repositories](private-repositories.md) for your Cloud Manager program, checks in GitHub run automatically for every pull request. These checks are annotated with information to help you identify any issues with your code as soon as possible.
...
The [Code Quality](/help/using/code-quality-testing.md) results are also visible in the pipeline, which Cloud Manager triggers automatically, at the bottom of the **Checks** tab. It is also accessible from the **Details** of the check for the pull request.
...
You can also view the issues as a CSV file. You can access this information by [viewing the details of the pipeline execution in Cloud Manager](/help/using/managing-pipelines.md).
